...
const ChatBot = () => {
  ...
  const chatWindow = (
    <section className="mb-4 flex h-[520px] w-[min(380px,calc(100vw-2rem))] flex-col overflow-hidden rounded-2xl border border-sky-400/20 bg-[#0b1220]/95 text-slate-100 shadow-[0_24px_70px_rgba(0,0,0,0.46)] backdrop-blur-xl">
      <header className="flex items-center justify-between border-b border-white/8 px-4 py-3">
        <div className="flex items-center gap-3">
          <span className="flex h-10 w-10 items-center justify-center rounded-xl border border-sky-400/25 bg-blue-500/10 text-sky-300">
            <Bot className="h-5 w-5" />
          </span>
          <div>
            <h2 className="text-sm font-bold text-white">Sentinel Guide</h2>
      ...
      <div className="border-t border-white/8 p-3">
        ...
        >
          <input
            ...
            placeholder="Ask about app operations..."
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      ...
      <button
        ...
        className="ml-auto flex h-14 w-14 items-center justify-center rounded-full border border-sky-400/30 bg-sky-500 text-white shadow-[0_16px_32px_rgba(14,165,233,0.28)] backdrop-blur transition hover:scale-105 hover:bg-sky-400 cursor-pointer"
